...
st.write("[![Star](https://img.shields.io/github/stars/irchamali/links.svg?logo=github&style=social)](https://github.com/irchamali/links)")
...
st.info('System Analyst and Informatics Lecturer')

icon_size = 20

st_button('linkedin', 'https://www.linkedin.com/in/ircham-ali/', 'Follow me on LinkedIn', icon_size)
st_button('youtube', 'https://www.youtube.com/@unusialabs', 'Unusia Labs', icon_size)
st_button('medium', 'https://irchamali.medium.com/', 'Read my Blogs', icon_size)
